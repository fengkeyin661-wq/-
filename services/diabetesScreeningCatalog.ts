...
export const DIABETES_SCREENING_CATALOG: ScreeningCatalogItem[] = [
  ...
  },
  {
    ...
    clinicalMeaning: '筛查糖尿病肾病及肾功能减退，可估算 eGFR',
    retestCycle: '每年',
    isCoreForDiabetes: true,
    priority: 'high',
    unit: 'μmol/L',
  ...
  },
  {
    ...
    clinicalMeaning: '高尿酸与代谢综合征、肾病风险相关',
    retestCycle: '每年',
    isCoreForDiabetes: true,
    priority: 'medium',
    unit: 'μmol/L',
  ...
  },
  {
    ...
    clinicalMeaning: '评估动脉粥样硬化及胰腺炎风险',
    retestCycle: '每年',
    isCoreForDiabetes: true,
    priority: 'high',
    unit: 'mmol/L',
