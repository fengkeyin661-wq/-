...
export const INDICATOR_EDUCATION: Record<string, IndicatorEdu> = {
  ...
  homocysteine: {
    itemId: 'homocysteine',
    label: '同型半胱氨酸',
    concept: '含硫氨基酸代谢产物，与叶酸、B族维生素代谢相关',
    principle: '水平升高可损伤血管内皮，增加血栓与心血管事件风险',
    referenceRange: '5–15 μmol/L（因实验室而异）',
    clinicalMeaning: '糖尿病合并高同型半胱氨酸血症者心血管风险进一步增加',
    retestCycle: '每年（高危人群）',
  },
  adiponectin: {
    itemId: 'adiponectin',
    label: '脂联素',
    concept: '脂肪细胞分泌的保护性因子，与胰岛素敏感性正相关',
    principle: '水平降低提示胰岛素抵抗及代谢综合征风险',
    referenceRange: '因性别与检测方法而异',
    clinicalMeaning: '辅助评估代谢风险，常规临床管理中非必检项目',
    retestCycle: '专科评估时',
  },
  urine_routine: {
    itemId: 'urine_routine',
    label: '尿常规+镜检',
    concept: '检测尿液理化性质及镜下成分',
    principle: '蛋白尿、糖尿、潜血等异常提示肾脏或代谢问题',
    referenceRange: '蛋白、葡萄糖、潜血阴性',
    clinicalMeaning: '基础筛查项目，异常需结合UACR与肾功能进一步评估',
    retestCycle: '每年',
  },
  lower_limb_us: {
    itemId: 'lower_limb_us',
    label: '下肢血管彩超',
    concept: '超声评估下肢动脉血流与狭窄情况',
    principle: '下肢动脉缺血是糖尿病足的重要危险因素',
    referenceRange: '动脉血流通畅，无显著狭窄',
    clinicalMeaning: '有间歇性跛行、足背动脉搏动减弱者应重点筛查',
    retestCycle: '有症状或高危时；一般每年评估',
  },
  ncv: {
    itemId: 'ncv',
    label: '神经传导速度',
    concept: '电生理测定周围神经传导功能',
    principle: '传导速度减慢提示周围神经病变',
    referenceRange: '各神经传导速度在正常范围',
    clinicalMeaning: '客观诊断糖尿病周围神经病变的金标准之一',
    retestCycle: '有症状或确诊神经病变后定期复查',
  },
};
