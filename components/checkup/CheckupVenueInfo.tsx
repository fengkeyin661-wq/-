...
/** 首页突出展示：体检时间 / 地址 / 咨询电话 */
export const CheckupVenueInfo: React.FC<Props> = ({ guide }) => {
  return (
    <section className="mx-4 mb-4 rounded-2xl border border-emerald-100 bg-white shadow-sm overflow-hidden">
      ...
      <div className="divide-y divide-slate-100 px-4">
        ...
        <div className="py-4">
          <div className="text-sm font-black text-emerald-800 mb-2">{guide.addressTitle}</div>
